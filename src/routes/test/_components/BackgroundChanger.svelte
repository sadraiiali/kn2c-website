<script>
	import { background } from '../../_stores/UiConfigStores';

	function changeBackground(backgroundSelected) {
		$background = backgroundSelected;
	}

	$: changeBackground(backgroundSelected);
	let backgroundSelected = 'bg-blue-700';
...
<div class='relative inline-flex'>
	...
	<select bind:value={backgroundSelected}
